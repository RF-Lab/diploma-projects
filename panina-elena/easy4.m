...
for g = 1:gend
    ...
    xyz_Mean_pos(:,gend)=me;%—редн€€ позици€, рассчитанна€ по 22 эпохам
    ...
    xyz_Base_comp(:,gend) = me1;%Ѕазовые компоненты, рассчитанные по 22 эпохам
    ...
    %средние значени€ по xyz_Mean_pos
    Smean_Mean_pos = mean(xyz_Mean_pos') %по сути это spread
    %средние значени€ по xyz_Base_comp
